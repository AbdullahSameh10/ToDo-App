import { TasksListElement, toggleCompletedTasksBtn } from "./variables";
...
export const UpdateList = (tasks) => {
  ...
  tasks.forEach((task) => {
    TasksListElement.innerHTML += `<li class="TaskList__taskContent ${task.isCompleted && "TaskList__taskContent--isActive"}">
